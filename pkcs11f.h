...
/* C_LoginBegin starts login for K/N card set into a token. */
...
/* C_LoginNext logs in a user share of K/N card set into a token. */
...
/* C_LoginEnd finalizes login into a token with K/N card set. */
